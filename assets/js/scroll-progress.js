...
(function (ScrollProgress) {
  class Menu {
    ...
    UpdateCursorPosition(progress) {
      ...
      let indexParagraph = this._menuItems.findIndex(
        (i) => i.Id == progress.Id
      );
      ...
      let curentCursorPosition =
        height -
        currentItemHeight +
        ((_b =
          (_a = this === null || this === void 0 ? void 0 : this._cursor) ===
            null || _a === void 0
            ? void 0
            : _a.Height) !== null && _b !== void 0
          ? _b
          : 0) +
        (currentItemHeight * progress.Percent) / 100;
      (_c = this === null || this === void 0 ? void 0 : this._cursor) ===
        null || _c === void 0
        ? void 0
        : _c.Move(curentCursorPosition);
    }
    ReInit() {
      this._menuItems = this.MapToMenuItems(this._menuHtmlElements);
    }
    MapToMenuItems(elements) {
      let menuItems = Array.from(elements).map((element, index) => {
        var _a, _b, _c;
        let id =
          (_a = element.getAttribute("href")) === null || _a === void 0
            ? void 0
            : _a.replace("#", "");
        let currentElementHeight = Math.round(
          element.getBoundingClientRect().top
        );
        let nextElementHeight = Math.round(
          (_c =
            (_b = elements[index + 1]) === null || _b === void 0
              ? void 0
              : _b.getBoundingClientRect()) === null || _c === void 0
            ? void 0
            : _c.top
        );
        if (!nextElementHeight)
          nextElementHeight =
            this._menuBody.getBoundingClientRect().height +
            this._menuBody.getBoundingClientRect().top;
        return new ScrollProgress.MenuItem(
          id,
...
(function (ScrollProgress) {
  class Page {
    constructor(height, menuBody, cursorBody, onScrolled, onChanged) {
      ...
      this._menu = new ScrollProgress.Menu(
        menuBody,
        menuBody.getElementsByTagName("a"),
        cursorBody
      );
      ...
      (_a = this._onScrolled) === null || _a === void 0
        ? void 0
        : _a.call(this, this.Progress);
      window.addEventListener("scroll", () => this.Scrolling());
      window.addEventListener("resize", () => this.ReInitRunnwer());
    }
    MapToParagraphs(menyItems) {
      let queryString = menyItems.map((link) => `#${link.Id}`).join(", ");
      let paragraphs = Array.from(document.querySelectorAll(queryString)).map(
        (element, index, array) => {
          var _a, _b;
          let currentElementHeight = Math.round(
          ...
          let nextElementHeight = Math.round(
            ((_b =
              (_a = array[index + 1]) === null || _a === void 0
                ? void 0
                : _a.getBoundingClientRect()) === null || _b === void 0
              ? void 0
              : _b.top) + window.pageYOffset
          );
          if (!nextElementHeight) nextElementHeight = this._height;
          return new ScrollProgress.Paragraph(
    ...
    get CurrentParagraph() {
      var _a, _b;
      let curentParagraph =
        (_a = this._paragraphs.find((paragraph) => {
          if (
            this._curentPosition >= paragraph.Top &&
      ...
      if (curentParagraph.Id != this._oldParagraph) {
        (_b = this._onChanged) === null || _b === void 0
          ? void 0
          : _b.call(
              this,
              curentParagraph === null || curentParagraph === void 0
                ? void 0
                : curentParagraph.Id
            );
    ...
    get Progress() {
      ...
      let progress = Math.round(
        ((this._curentPosition - curentParagraph.Top) /
          curentParagraph.Height) *
          100
      );
      return {
    ...
    CheckParagraphLinks(paragraphs, menuItems) {
      menuItems.every((par) => {
        ...
        if (paragraph) return true;
          ...
          throw new Error(
            `Menu item with id '${par.Id}' not linked for paragraph!`
          );
      });
    }
    ReInit() {
...
(function (ScrollProgress) {
  class Init {
    constructor(cursorSelector, menuSelector, onScrolled, onChanged) {
      ...
      this._page = new ScrollProgress.Page(
        height,
        menu,
        cursor,
        onScrolled,
